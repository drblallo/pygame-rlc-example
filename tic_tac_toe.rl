...
cls Board:
    ...
    fun on_slot_change(Int x, Int y):
        let args : PyObject[3]
        args[0] = to_pyobject(x)
        args[1] = to_pyobject(y)
        args[2] = to_pyobject(self.current_player())
        self.event_receiver.call("on_slot_change", args)

    fun set_handler(PyObject obj):
